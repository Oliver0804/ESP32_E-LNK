...
#define FT6336_SCL_L() digitalWrite(A2,LOW)
#define FT6336_SCL_H() digitalWrite(A2,HIGH)
#define FT6336_SDA_L()  digitalWrite(A3,LOW)
#define FT6336_SDA_H()  digitalWrite(A3,HIGH) 
#define FT6336_RST_L() digitalWrite(A1,LOW)
#define FT6336_RST_H() digitalWrite(A1,HIGH)
#define Is_SDA_IN  digitalRead(A3)
//mode  setting
#define SDA_IN()    pinMode(A3, INPUT)    //
#define SDA_OUT()   pinMode(A3, OUTPUT)   //

//#define GND_OUT_Mode()   pinMode(0, OUTPUT)  
//#define VCC_OUT_Mode()   pinMode(3, OUTPUT)  
#define RST_OUT_Mode()   pinMode(A1, OUTPUT)  
#define SCL_OUT_Mode()   pinMode(A2, OUTPUT)  

//#define FT6336_PWR() digitalWrite(3,HIGH)  
//#define FT6336_GND() digitalWrite(0,LOW)
